...
export const CheckvalidateSignUp = joi.object({
  ...
  address: joi.string().required().messages({
    "string.required": "Trường address là bắt buộc",
    "string.required": "Vui lòng nhập address",
  }),
  phone: joi.string().required().messages({
    "string.required": "Trường phone là bắt buộc",
    "string.required": "Vui lòng nhập phone",
  }),
